...
export default function RSSFeeder() {
  ...
  useEffect(() => {
    fetch(
      "https://api.allorigins.win/get?url=https://store.steampowered.com/feeds/news/app/386360/?cc=US&l=english&snr=1_2108_9__2107"
    ).then((res) =>
      res.json().then((data) => {
  ...
  return (
    ...
    <>
      <InfiniteScroll
        ...
        height={775}
      >
        <div className="content-section_header">SMITE Update Info</div>
