                        ...
                        <div className="rt-tr" role="row" {...row.getRowProps()}>
                          {row.cells.map((cell) => {
                            ...
                            <div className="rt-td role" style={{ minWidth: "40px", maxWidth: "60px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                              ...
                              return(
                                <div className="rt-td" style={{ minWidth: "65px", maxWidth: "70px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                                  <span><b>{row.original.kills}</b></span>
                                </div>
                              )
                            } else if (key.includes("deaths")) {
                              return(
                                <div className="rt-td" style={{ minWidth: "65px", maxWidth: "70px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                                  <span><b>{row.original.deaths}</b></span>
                                </div>
                              )
                            } else if (key.includes("assists")) {
                              return(
                                <div className="rt-td" style={{ minWidth: "65px", maxWidth: "70px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                                  <span><b>{row.original.assists}</b></span>
                                </div>
                              )
                            } else if (key.includes("damageD")) {
                              return(
                                <div className="rt-td" style={{ minWidth: "60px", maxWidth: "90px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                                  <span><b>{row.original.damageD}</b></span>
                                </div>
                              )
                            } else if (key.includes("damageTaken")) {
                              return(
                                <div className="rt-td" style={{ minWidth: "60px", maxWidth: "90px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                                  <span><b>{row.original.damageTaken}</b></span>
                                </div>
                              )
                            } else if (key.includes("damageMitigated")) {
                              return(
                                <div className="rt-td" style={{ minWidth: "60px", maxWidth: "90px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                                  <span><b>{row.original.damageMitigated}</b></span>
                                </div>
                              )
                            } else if (key.includes("healing")) {
                              return(
                                <div className="rt-td" style={{ minWidth: "60px", maxWidth: "90px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                                  <span><b>{row.original.healing}</b></span>
                                </div>
                              )
                            } else if (key.includes("selfHealing")) {
                              return(
                                <div className="rt-td" style={{ minWidth: "60px", maxWidth: "90px", flex: "1 1 100%" }} {...cell.getCellProps()}>
                                  <span><b>{row.original.selfHealing}</b></span>
                                </div>
                              )
                            } 
