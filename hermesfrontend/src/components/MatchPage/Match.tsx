...
export default function Match(props: any) {
  ...
  return (
    <div className='content-container'>
      <div className=' match-content' style={{ maxWidth: 'fit-content' }}>
        <div className='content-section shrink-padding'>
          <div className='content-section_header'>Match Summary&nbsp;</div>
