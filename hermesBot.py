        ...
        if message.content.lower().startswith("$build"):
            ...
            if len(m) < 2:
                ...
                if len(m) == 2 or (
                    len(m) > 2
                    and m[-1].lower()
                    not in ["solo", "jungle", "mid", "support", "carry"]
                ):
                    god = m[1 : len(m)]
                    god = " ".join(god)
                ...
                if not color:
                    await message.channel.send(
                        f"God Not Found, check spelling of: {message.content.lower()}"
                    )
                embed = discord.Embed(
                    title=f"{actgod} {role} Build".title(),
                    description="Games: {} | Wins: {} | WR: {} \n [See more info here](https://www.smitestats.gg/#/{})".format(
                        data["games"],
                        data["wins"],
                        data["winRate"],
                        actgod.replace(" ", "_"),
                ...
                for i, slot in enumerate(data):
                    if "slot" in slot:
                        ...
                        if item1:
                            item1WR = round(
                                data[slot]["item1"]["wins"]
                                / data[slot]["item1"]["games"]
                                * 100,
                                2,
                            )
                        else:
                        ...
                        if item2:
                            item2WR = round(
                                data[slot]["item2"]["wins"]
                                / data[slot]["item2"]["games"]
                                * 100,
                                2,
                            )
                        else:
        ...
        if message.content.lower().startswith("$matchups"):
            ...
            if len(m) < 2:
                ...
                if actgod.lower() in (assassin.lower() for assassin in Assassins):
                    ...
                    color = "fc0303"
                embed = discord.Embed(
                    title=actgod + " " + role + " Worst Matchups".title(),
                    description="Games: {} | Wins: {} | WR: {} \n [See more info here](https://www.smitestats.gg/#/{})".format(
                        data["games"],
                        data["wins"],
                        data["winRate"],
                ...
                for i, matchup in enumerate(data):
                    if matchup not in ["games", "wins", "winRate"] and i < 4:
                        embed.add_field(
                            name=matchup,
                            value="Games Played: "
                            + str(data[matchup]["timesPlayed"])
                            + "\nWR: "
                            + str(data[matchup]["winRate"])
                            + "%",
                            inline=True,
                        )
                await message.channel.send(embed=embed)
        ...
        if message.content.lower().startswith("$goodmatchups"):
            ...
            if len(m) < 2:
                ...
                if actgod.lower() in (assassin.lower() for assassin in Assassins):
                    ...
                    color = "fc0303"
                embed = discord.Embed(
                    title=f"{actgod} {role} Best Matchups".title(),
                    description="Games: {} | Wins: {} | WR: {} \n [See more info here](https://www.smitestats.gg/#/{})".format(
                        data["games"],
                        data["wins"],
                        data["winRate"],
                ...
                embed.set_thumbnail(url=iconURL)
                for i, matchup in enumerate(data):
                    if matchup not in ["games", "wins", "winRate"] and i > (
                        len(data) - 9
                    ):
                        embed.add_field(
                            name=matchup,
        ...
        if message.content.lower().startswith("$paths"):
            ...
            if len(m) < 2:
                ...
                if actgod.lower() in (assassin.lower() for assassin in Assassins):
                    ...
                    color = "fc0303"
                embed = discord.Embed(
                    title=f"{actgod} {role} Build Paths".title(),
                    description="[See more info here](https://www.smitestats.gg/#/{})".format(
                        actgod.replace(" ", "_")
                    ),
                    color=int(color, base=16),
                )
                    ...
                    if i < 2:
                        ...
                        embed.add_field(
                            ...
                            value="{}\nGames: {} Win Rate: {}".format(
                                path.replace(",", ", "),
                                games,
                                round(data[path]["wins"] / games * 100, 2),
                            ),
                            inline=True,
                        )
                await message.channel.send(embed=embed)
